  ...
  return (
    <Stack spacing={3}>
      ...
      <FormControl>
        ...
        >
          <FormControlLabel value="image" control={<Radio />} label="Single image" />
          <FormControlLabel value="video" control={<Radio />} label="Single video" />
        </RadioGroup>
      </FormControl>
        ...
        {creative.image_preview_url && (
          <Box sx={{ mt: 2 }}>
            <img
              ...
              alt="Ad preview"
              style={{ maxWidth: 320, borderRadius: 8, border: '1px solid rgba(255,255,255,0.12)' }}
            />
          </Box>
        )}
